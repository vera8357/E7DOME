  ...
  <div class="group">
    ...
    <div class="group_form">
      ...
      <?php
          ...
          echo '<div><label for="">揪團名稱:</label>';
          echo '<input type="text" name="TEAM_NAME" minlength="3" maxlength="10" required></div>';//揪團名稱

          echo '<div><label for="">揪團簡介:</label>';
          echo '<textarea name="TEAM_INFO" id="" cols="30" rows="10" required></textarea><?div>';//揪團簡介

          echo '<div><label for="">揪團人數:</label>';//揪團人數
