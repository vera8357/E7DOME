        ...
        <div class="site_info_wrap">
            ...
            <div class="info">
                ...
                <div class="site_select">
                    <input type="hidden" name="cate_no" value="2"> //1.籃球場2.保齡球場3.羽球場4.攀岩場
            ...
            <div class="home_team">
                <ul class="teamGroup">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM team JOIN booking ON (team.BOO_NO = booking.BOO_NO) JOIN facility ON (facility.FAC_NO = booking.FAC_NO) where facility.CATE_NO = 2 order by facility.FAC_NO desc limit 3";
                        $team = $pdo->query( $sql);
