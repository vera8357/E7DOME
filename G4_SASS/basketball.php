        ...
        <div class="home_team">
            <ul class="teamGroup">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM team JOIN booking ON (team.BOO_NO = booking.BOO_NO) JOIN facility ON (facility.FAC_NO = booking.FAC_NO) where facility.CATE_NO = 1 order by facility.FAC_NO desc limit 3";
                    $team = $pdo->query( $sql);
