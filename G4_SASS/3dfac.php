...
<div class="container">
	<div class="main">
		...
		<div class="mall">
			...
			<div class="levels">
				...
				<div class="level level--2" aria-label="Level 2" data-category="2">
				...
				<div class="level level--3" aria-label="Level 3" data-category="3">
				...
				<div class="level level--4" aria-label="Level 4" data-category="1">
					<svg class="map map--4" viewBox="0 0 419.5 262" style="enable-background:new 0 0 419.5 262;" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
						...
						<g id="ground01">
							<path class="st8" d="M172.8,131c0-22,17.8-39.8,39.8-39.8V0H0v24.3h37.7c58.7,0,106.7,48,106.7,106.7v0c0,58.7-48,106.7-106.7,106.7H0V262h212.7v-91.2C190.7,170.8,172.8,153,172.8,131z" />
							<path class="st8" d="M144.3,131L144.3,131c0-58.7-48-106.7-106.7-106.7H0v73.8l87.7,8v0.5c13.5,0,24.4,10.9,24.4,24.4c0,13.5-10.9,24.4-24.4,24.4v0.5l-87.7,8v73.8h37.7C96.3,237.7,144.3,189.7,144.3,131z" />
							...
							<path class="st8" d="M252.8,131c0-22-17.8-39.8-39.8-39.8V0l212.7,0v24.3H388c-58.7,0-106.7,48-106.7,106.7v0c0,58.7,48,106.7,106.7,106.7h37.7V262H213v-91.2C235,170.8,252.8,153,252.8,131z" />
							<path class="st8" d="M281.3,131L281.3,131c0-58.7,48-106.7,106.7-106.7h37.7v73.8l-87.7,8v0.5c-13.5,0-24.4,10.9-24.4,24.4c0,13.5,10.9,24.4,24.4,24.4v0.5l87.7,8v73.8H388C329.3,237.7,281.3,189.7,281.3,131z" />
		...
		<div class="content">
			<div class="content__item" data-space="1.01" data-category="4" id="queryCate4"></div>
			<div class="content__item" data-space="2.01" data-category="2" id="queryCate2"></div>
			<div class="content__item" data-space="3.01" data-category="3" id="queryCate3"></div>
			<div class="content__item" data-space="4.01" data-category="1" id="queryCate1"></div>
	...
	<aside class="spaces-list" id="spaces-list">
		...
		<ul class="list grouped-by-category">
	        ...
	        <li class="list__item" data-level="4" data-category="4" data-space="4.01"><a href="#" class="list__link">籃球場</a></li>
		</ul>
	</aside>
	<!-- /spaces-list -->
</div>
